...
enum zxdg_toplevel_decoration_v1_mode {
	...
	ZXDG_TOPLEVEL_DECORATION_V1_MODE_CLIENT_AND_SERVER_SIDE = 3,
};
...
static inline int
zxdg_decoration_manager_v1_add_listener(struct zxdg_decoration_manager_v1 *zxdg_decoration_manager_v1,
					const struct zxdg_decoration_manager_v1_listener *listener, void *data)
{
	return wl_proxy_add_listener((struct wl_proxy *) zxdg_decoration_manager_v1,
...
zxdg_decoration_manager_v1_get_toplevel_decoration(struct zxdg_decoration_manager_v1 *zxdg_decoration_manager_v1, struct xdg_toplevel *toplevel)
{
	...
	id = wl_proxy_marshal_constructor((struct wl_proxy *) zxdg_decoration_manager_v1,
			 ...
			 &zxdg_toplevel_decoration_v1_interface, NULL, toplevel);
